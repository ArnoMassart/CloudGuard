...
const PW_SETTINGS_I18N: Record<string, string> = {
  ...
  'password-settings.users-password-changes': 'Forced password change',
  'password-settings.users-password-text': 'user(s) must change password at next login',
  'password-settings.email': 'Email',
  'password-security-key': 'Security Key',
  'password-settings.ou-status': 'Status',
  problems: 'problems',
